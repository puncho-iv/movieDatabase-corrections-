      ...
      <><div id="footer">
        <div className="footer_container">
          ...
          <ul className="footer-mid-links">
            ...
            {this.state.footerMid.map((footerMid) => (
              <li>{footerMid}</li>
            ))}
          </ul>
        </div>
        ...
        <div className="footer-socials" id="socials">
          <Link
            to="https://www.instagram.com/unicusdesigns_/"
            className="permalinks"
          >
            <AiFillInstagram />
          </Link>
          <Link
            to="https://www.behance.net/UNICUSDESIGNS"
            className="permalinks"
          >
            <AiOutlineTwitter />
          </Link>
          <Link
            to="https://www.linkedin.com/in/ebenezer-omani-clottey/"
            className="permalinks"
          >
